:PROPERTIES:
:ID:       eee0a79e-f65c-4ec8-880f-803fd950365c
:END:
...
:ID:       711b48c6-6529-49c8-bd5d-0626b3a2e005
:END:
...
*** isync
:PROPERTIES:
:ID:       41893352-d5d3-49ce-b4bb-daec6d38c7a0
:END:
...
*** offlineimap
:PROPERTIES:
:ID:       a0b3d156-43a0-429c-9ba8-01466c9d831f
:END:
...
** Sending
:PROPERTIES:
:ID:       76fb36b7-4b42-4347-b168-4c7c49b0ae0b
:END:
...
** Files
:PROPERTIES:
:ID:       977eeaac-d867-4e7d-8a26-5f3f97354521
:END:
...
I will test having a more granular time grid
#+BEGIN_SRC emacs-lisp :tangle ~/.doom.d/config.el
...
(defun my/push-dailies-to-weekly ()
  ...
  (interactive)
  (org-ql-query
    :select (λ!  (org-set-tags (cons "weeklyreview" (org-get-tags))))
    :from (current-buffer)
    :where '(and (todo)
                 (not (org-entry-blocked-p))
...
I want to still count the break as worktime, because the breaks are neccesary
for work.
#+BEGIN_SRC emacs-lisp :noweb-ref emacs-misc
    (after! org-pomodoro
...
** Latex
:PROPERTIES:
:ID:       6eeb7136-2da1-43d3-9175-5892668d491a
:END:
#+BEGIN_SRC emacs-lisp :tangle ~/.doom.d/config.el
...
#+BEGIN_SRC :tangle ~/.doom.d/config.el
